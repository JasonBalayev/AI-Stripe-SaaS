  ...
  return (
    <Container maxWidth="lg" sx={{ backgroundColor: "#f5f5f5", minHeight: '100vh', paddingBottom: 5 }}>
      ...
      <Box sx={{ textAlign: "center", my: 4 }}>
        ...
        <Button variant="contained" color="primary" sx={{ mt: 2, px: 4, py: 1.5, borderRadius: '30px', fontSize: '1.2rem', fontWeight: 'bold' }}>
          Get Started
        </Button>
      </Box>
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            <Box sx={{
              ...
              <Button variant="contained" color="primary" sx={{ mt: 2, px: 4, py: 1.5, fontSize: '1rem', fontWeight: 'bold', borderRadius: '30px' }}>
                Choose basic
              </Button>
            </Box>
          </Grid>
