...
import { FaLinkedin, FaGithub, FaGlobe } from 'react-icons/fa'; // Importing additional icons
        ...
        <Container maxWidth="lg">
          <Box sx={{ display: 'flex', justifyContent: 'center', gap: 6 }}>
            ...
            <Box
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Jason's Personal Website"
              sx={{ 
                display: 'flex', 
                alignItems: 'center', 
                color: '#black', 
            ...
            >
              <FaGlobe size={24} style={{ marginRight: '8px' }} />
              Website
            </Box>
          </Box>
        </Container>
